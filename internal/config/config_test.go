...
func TestLoad(t *testing.T) {
	...
	require.EqualError(t, err, "error decoding config block config_test.Foo/ReallyBad into &{ 0 same ReallyBad}: yaml: construct errors: line 32: cannot construct !!str `infinite` into int")
